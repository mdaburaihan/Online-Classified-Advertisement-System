...
<div class="well" style="height: 130px;">
	<h4>Search Advertisments Status Wise</h4>
...
<div id="main-content">
  <div class="container-fluid">
    <div class="panel panel-primary">
      <div class="panel-heading" style="text-align: center;font-size: 16px;">Status Wise Advertisements</div>
        ...
        if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['search'])){
         ...
         if($status=="")
         {
          echo "<script>alert('Please Select Status.');</script>";
           ?>
            <script>
            window.location="search_status_wise.php";
          </script>
          <?php
        }
        
        $allAds =$ads -> getAdsStatusWise($_POST);
        if(empty($allAds))
        {
