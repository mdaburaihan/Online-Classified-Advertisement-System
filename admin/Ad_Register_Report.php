...
$pdf->AddCol('AdId',20,'','L');
$pdf->AddCol('Date',32,'Date','L');
$pdf->AddCol('Title',55,'Advertisement Title','L');
$pdf->AddCol('Price',20,'','L');
$pdf->AddCol('Status',25,'','L');
$pdf->AddCol('Category',55,'','L');
$pdf->AddCol('Subcategory',55,'','L');
$pdf->AddCol('City',25,'','L');
