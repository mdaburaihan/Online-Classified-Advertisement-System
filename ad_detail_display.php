<?php 
$title="Ad Details | Online Classified Advertisement System ";
...
if($adById){
	...
	<div class="container">
			...
			<div class="tab-content" style="border:1px solid #e7ebff;background-color: #e7ebff;">
				...
				<div id="menu1" class="tab-pane fade">
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
								    ...
								    {
								        echo"<h4>Please Login as Buyer to view Seller's Info.</h4>";
								    }
									?>
								</div>
						...
						<div class="col-lg-4">
						    <p style="border:1px solid blue;background-color: #fafcf3;padding-left: 10px">
								<b><u>Saftey tips :</u></b><br>
								1. Meet seller at public or safe place.<br>
								2. Check the product before accept.<br>
								3. Pay only after collecting product.<br>
							</p>
		...
		<div class="row" style="margin-top: 40px;margin-bottom: 40px;padding-left: 50px;padding-right: 50px;">
			...
			<div class="col-lg-4">
				<button type="button" class="btn btn-default btn-md" onclick="location.href = 'index.php';"><< Go Back</button>
			</div>
			<div class="col-lg-4">
			...
			<div class="col-lg-4" style="text-align: right;">
				<div class="col-lg-6">
					...
					<!--<button type="submit"  name="confirm" class="btn btn-default btn-md">Confirm</button>-->
					</form>
				</div>
				<div class="col-lg-6">
					...
					<form name="addWish" method="post">
						...
						<button type="submit" name="addwishlist" class="btn btn-default btn-md">Add to Wishlist</button>
					</form>
				</div>
			</div>
		</div>
